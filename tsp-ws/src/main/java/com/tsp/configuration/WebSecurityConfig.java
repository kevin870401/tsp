...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests().antMatchers("/").permitAll()
				.antMatchers("/error").permitAll().antMatchers("/saml/**")
	...
	private ArtifactResolutionProfile artifactResolutionProfile() {
		final ArtifactResolutionProfileImpl artifactResolutionProfile = new ArtifactResolutionProfileImpl(
				httpClient());
		artifactResolutionProfile.setProcessor(new SAMLProcessorImpl(
				soapBinding()));
	...
	public SAMLAuthenticationProvider samlAuthenticationProvider() {
		...
		// OPTIONAL property:setUserDetails can be used to store/load user data
		// after login
	...
	public WebSSOProfileOptions defaultWebSSOProfileOptions() {
		...
		webSSOProfileOptions
				.setBinding(org.opensaml.common.xml.SAMLConstants.SAML2_POST_BINDING_URI);
	...
	public ResourceBackedMetadataProvider resourceBackedMetadataProvider()
		...
		ResourceBackedMetadataProvider resourceBackedMetadataProvider = new ResourceBackedMetadataProvider(
				new Timer(),
				new ClasspathResource("/federationMetadataDev.xml"));
	...
	public ResourceBackedMetadataProvider resourceBackedMetadataProvider2()
			throws ResourceException, MetadataProviderException {

		ResourceBackedMetadataProvider resourceBackedMetadataProvider = new ResourceBackedMetadataProvider(
				new Timer(), new ClasspathResource("/publicIdp.xml"));
		resourceBackedMetadataProvider.setParserPool(parserPool());
		return resourceBackedMetadataProvider;
	}
	...
	public CachingMetadataManager metadata() throws MetadataProviderException,
		...
		ExtendedMetadataDelegate adfsMetadata = new ExtendedMetadataDelegate(
				resourceBackedMetadataProvider(), new ExtendedMetadata());
		adfsMetadata.setMetadataTrustCheck(false);
		ExtendedMetadataDelegate adfsMetadata2 = new ExtendedMetadataDelegate(
				resourceBackedMetadataProvider2(), new ExtendedMetadata());
